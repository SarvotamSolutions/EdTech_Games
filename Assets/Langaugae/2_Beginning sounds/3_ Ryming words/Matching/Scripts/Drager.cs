            ...
            if (Input.GetMouseButtonUp(0) && !answered && GameController.Instance.selected_Line== line )
            {
                ...
                if (Vector3.Distance(line.GetPosition(1), Answeroption.transform.position) <= 2)
                {
                 ...
                 //   GameController.Instance.gamePlay = false;
                    ...
                    arrow.transform.GetChild(0).GetComponent<SpriteRenderer>().color = GameController.Instance.currect_answer_color;
                    line.startColor = GameController.Instance.currect_answer_color;
                    line.endColor = GameController.Instance.currect_answer_color;
